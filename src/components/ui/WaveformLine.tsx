...
export function WaveformLine({ 
  ...
  const basePath = "M0,15 Q25,5 50,15 T100,15 T150,15 T200,15";
  const altPath1 = "M0,15 Q25,25 50,15 T100,15 T150,15 T200,15";
  const altPath2 = "M0,15 Q25,5 50,15 T100,15 T150,15 T200,15";
